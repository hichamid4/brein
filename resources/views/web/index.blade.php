@extends('web.shared.layouts.blankLyout')
...
@section('content')
  ...
  <!-- Header -->
    @include('web.shared.components.header')
  <!-- /Header -->
						...
						<div class="col-lg-5">
							<div class="banner-imgs">
								<div class="banner-1 shape-1">
									<img class="img-fluid" alt="banner" src="website/assets/img/banner1.png">
								</div>
								<div class="banner-2 shape-3">
									<img class="img-fluid" alt="banner" src="website/assets/img/banner2.png">
								</div>
								<div class="banner-3 shape-3">
									<img class="img-fluid" alt="banner" src="website/assets/img/banner3.png">
								</div>
								<div class="banner-4 shape-2">
									<img class="img-responsive" alt="banner" src="website/assets/img/banner4.png">
								</div>
							</div>
						</div>
					</div>
					...
					<div class="col-md-6 col-lg-3">
						<a href="service-details.html" class="feature-box aos" data-aos="fade-up">
							<div class="feature-icon">
								<span>
									<img src="website/assets/img/icons/feature-icon-01.svg" alt="img">
								</span>
							</div>
							<h5>Construction</h5>
							<div class="feature-overlay">
								<img src="website/assets/img/services/service-02.jpg" alt="img">
							</div>
						</a>
					</div>
					<div class="col-md-6 col-lg-3">
						<a href="service-details.html" class="feature-box aos" data-aos="fade-up">
							<div class="feature-icon">
								<span>
									<img src="website/assets/img/icons/feature-icon-02.svg" alt="img">
								</span>
							</div>
							<h5>Car Wash</h5>
							<div class="feature-overlay">
								<img src="website/assets/img/feature.jpg" alt="img">
							</div>
						</a>
					</div>
					<div class="col-md-6 col-lg-3">
						<a href="service-details.html" class="feature-box aos" data-aos="fade-up">
							<div class="feature-icon">
								<span>
									<img src="website/assets/img/icons/feature-icon-03.svg" alt="img">
								</span>
							</div>
							<h5>Electrical</h5>
							<div class="feature-overlay">
								<img src="website/assets/img/services/service-01.jpg" alt="img">
							</div>
						</a>
					</div>
					<div class="col-md-6 col-lg-3">
						<a href="service-details.html" class="feature-box aos" data-aos="fade-up">
							<div class="feature-icon">
								<span>
									<img src="website/assets/img/icons/feature-icon-04.svg" alt="img">
								</span>
							</div>
							<h5>Cleaning</h5>
							<div class="feature-overlay">
								<img src="website/assets/img/services/service-09.jpg" alt="img">
							</div>
						</a>
					</div>
					<div class="col-md-6 col-lg-3">
						<a href="service-details.html" class="feature-box aos" data-aos="fade-up">
							<div class="feature-icon">
								<span>
									<img src="website/assets/img/icons/feature-icon-05.svg" alt="img">
								</span>
							</div>
							<h5>Interior</h5>
							<div class="feature-overlay">
								<img src="website/assets/img/services/service-07.jpg" alt="img">
							</div>
						</a>
					</div>
					<div class="col-md-6 col-lg-3">
						<a href="service-details.html" class="feature-box aos" data-aos="fade-up">
							<div class="feature-icon">
								<span>
									<img src="website/assets/img/icons/feature-icon-06.svg" alt="img">
								</span>
							</div>
							<h5>Carpentry</h5>
							<div class="feature-overlay">
								<img src="website/assets/img/services/service-03.jpg" alt="img">
							</div>
						</a>
					</div>
					<div class="col-md-6 col-lg-3">
						<a href="service-details.html" class="feature-box aos" data-aos="fade-up">
							<div class="feature-icon">
								<span>
									<img src="website/assets/img/icons/feature-icon-07.svg" alt="img">
								</span>
							</div>
							<h5>Computer</h5>
							<div class="feature-overlay">
								<img src="website/assets/img/services/service-06.jpg" alt="img">
							</div>
						</a>
					</div>
					<div class="col-md-6 col-lg-3">
						<a href="service-details.html" class="feature-box aos" data-aos="fade-up">
							<div class="feature-icon">
								<span>
									<img src="website/assets/img/icons/feature-icon-08.svg" alt="img">
								</span>
							</div>
							<h5>Plumbing</h5>
							<div class="feature-overlay">
								<img src="website/assets/img/services/service-11.jpg" alt="img">
							</div>
						</a>
					</div>
				</div>
					...
					<div class="col-md-12">
						<div class="owl-carousel service-slider">
							<div class="service-widget aos" data-aos="fade-up">
								<div class="service-img">
									<a href="service-details.html">
										<img class="img-fluid serv-img" alt="Service Image" src="website/assets/img/services/service-01.jpg">
									</a>
									<div class="fav-item">
									...
									<div class="item-info">
										<a href="providers.html"><span class="item-img"><img src="website/assets/img/profiles/avatar-01.jpg" class="avatar" alt=""></span></a>
									</div>
								</div>
							...
							<div class="service-widget aos" data-aos="fade-up">
								<div class="service-img">
									<a href="service-details.html">
										<img class="img-fluid serv-img" alt="Service Image" src="website/assets/img/services/service-02.jpg">
									</a>
									<div class="fav-item">
									...
									<div class="item-info">
										<a href="providers.html"><span class="item-img"><img src="website/assets/img/profiles/avatar-02.jpg" class="avatar" alt=""></span></a>
									</div>
								</div>
								<div class="service-content">
									<h3 class="title">
							...
							<div class="service-widget aos" data-aos="fade-up">
								<div class="service-img">
									<a href="service-details.html">
										<img class="img-fluid serv-img" alt="Service Image" src="website/assets/img/services/service-03.jpg">
									</a>
									<div class="fav-item">
									...
									<div class="item-info">
										<a href="providers.html"><span class="item-img"><img src="website/assets/img/profiles/avatar-03.jpg" class="avatar" alt=""></span></a>
									</div>
								</div>
								<div class="service-content">
									<h3 class="title">
							...
							<div class="service-widget aos" data-aos="fade-up">
								<div class="service-img">
									<a href="service-details.html">
										<img class="img-fluid serv-img" alt="Service Image" src="website/assets/img/services/service-11.jpg">
									</a>
									<div class="fav-item">
										<a href="categories.html"><span class="item-cat">Construction</span></a>
										<a href="javascript:void(0)" class="fav-icon">
									...
									<div class="item-info">
										<a href="providers.html"><span class="item-img"><img src="website/assets/img/profiles/avatar-04.jpg" class="avatar" alt=""></span></a>
									</div>
								</div>
								<div class="service-content">
									<h3 class="title">
				...
				<div class="row  aos" data-aos="fade-up">
						...
						<div class="providerset">
							<div class="providerset-img">
								<a href="provider-details.html">
									<img src="website/assets/img/provider/provider-11.jpg" alt="img">
								</a>
							</div>
					...
					<div class="col-lg-3 col-sm-6">
						<div class="providerset">
							<div class="providerset-img">
								<a href="provider-details.html">
									<img src="website/assets/img/provider/provider-12.jpg" alt="img">
								</a>
							</div>
							<div class="providerset-content">
								<div class="providerset-price">
					...
					<div class="col-lg-3 col-sm-6">
						<div class="providerset">
							<div class="providerset-img">
								<a href="provider-details.html">
									<img src="website/assets/img/provider/provider-13.jpg" alt="img">
								</a>
							</div>
							<div class="providerset-content">
								<div class="providerset-price">
					...
					<div class="col-lg-3 col-sm-6">
						<div class="providerset">
							<div class="providerset-img">
								<a href="provider-details.html">
									<img src="website/assets/img/provider/provider-14.jpg" alt="img">
								</a>
							</div>
							<div class="providerset-content">
								<div class="providerset-price">
					...
					<div class="col-md-12">
						<div class="offer-paths">
							<div class="offer-pathimg">
								<img src="website/assets/img/offer.png" alt="img">
							</div>
				...
				<div class="row">
					<div class="col-md-4">
						<div class="work-box aos" data-aos="fade-up">
							<div class="work-icon">
								<span>
									<img src="website/assets/img/icons/work-icon.svg" alt="img">
								</span>
							</div>
					...
					<div class="col-md-4">
						<div class="work-box aos" data-aos="fade-up">
							<div class="work-icon">
								<span>
									<img src="website/assets/img/icons/find-icon.svg" alt="img">
								</span>
							</div>
					...
					<div class="col-md-4">
						<div class="work-box aos" data-aos="fade-up">
							<div class="work-icon">
								<span>
									<img src="website/assets/img/icons/place-icon.svg" alt="img">
								</span>
							</div>
					...
					<div class="col-md-12">
						<div class="owl-carousel popular-slider">
							...
							<div class="service-widget aos" data-aos="fade-up">
								<div class="service-img">
									<a href="service-details.html">
										<img class="img-fluid serv-img" alt="Service Image" src="website/assets/img/services/service-04.jpg">
									</a>
									<div class="fav-item">
							...
							<div class="service-widget aos" data-aos="fade-up">
								<div class="service-img">
									<a href="service-details.html">
										<img class="img-fluid serv-img" alt="Service Image" src="website/assets/img/services/service-05.jpg">
									</a>
									<div class="fav-item">
										<a href="categories.html"><span class="item-cat">Cleaning</span></a>
										<a href="javascript:void(0)" class="fav-icon">
							...
							<div class="service-widget aos" data-aos="fade-up">
								<div class="service-img">
									<a href="service-details.html">
										<img class="img-fluid serv-img" alt="Service Image" src="website/assets/img/services/service-06.jpg">
									</a>
									<div class="fav-item">
							...
							<div class="service-widget aos" data-aos="fade-up">
								<div class="service-img">
									<a href="service-details.html">
										<img class="img-fluid serv-img" alt="Service Image" src="website/assets/img/services/service-08.jpg">
									</a>
									<div class="fav-item">
										<a href="categories.html"><span class="item-cat">Cleaning</span></a>
										<a href="javascript:void(0)" class="fav-icon">
						...
						<div class="owl-carousel testimonial-slider">
							...
							<div class="client-widget aos" data-aos="fade-up">
								<div class="client-img">
									<a href="#">
										<img class="img-fluid" alt="Image" src="website/assets/img/profiles/avatar-01.jpg">
									</a>
								</div>
							...
							<div class="client-widget aos" data-aos="fade-up">
								<div class="client-img">
									<a href="#">
										<img class="img-fluid" alt="Image" src="website/assets/img/profiles/avatar-02.jpg">
									</a>
								</div>
								<div class="client-content">
									<div class="rating">
							...
							<div class="client-widget aos" data-aos="fade-up">
								<div class="client-img">
									<a href="#">
										<img class="img-fluid" alt="Image" src="website/assets/img/profiles/avatar-03.jpg">
									</a>
								</div>
								<div class="client-content">
									<div class="rating">
			...
			<div class="container">
				...
				<div class="row justify-content-between">
					<div class="col-lg-4 col-md-6 d-flex">
						<div class="blog flex-fill aos" data-aos="fade-up">
							<div class="blog-image">
								<a href="blog-details.html"><img class="img-fluid" src="website/assets/img/blog/blog-01.jpg" alt="Post Image"></a>
							</div>
					...
					<div class="col-lg-4 col-md-6 d-flex">
						<div class="blog flex-fill aos" data-aos="fade-up">
							<div class="blog-image">
								<a href="blog-details.html"><img class="img-fluid" src="website/assets/img/blog/blog-02.jpg" alt="Post Image"></a>
							</div>
							<div class="blog-content">
								<ul class="blog-item">
									<li><i class="feather-calendar"></i>09 Aug 2022</li>
					...
					<div class="col-lg-4 col-md-6 d-flex">
						<div class="blog flex-fill aos" data-aos="fade-up">
							<div class="blog-image">
								<a href="blog-details.html"><img class="img-fluid" src="website/assets/img/blog/blog-03.jpg" alt="Post Image"></a>
							</div>
							<div class="blog-content">
								<ul class="blog-item">
									<li><i class="feather-calendar"></i>09 Aug 2022</li>
				...
				<div class="row">
					...
					<div class="owl-carousel partners-slider aos " data-aos="fade-up">
						<div class="partner-img">
							<img src="website/assets/img/partner/partner1.svg" alt="img">
						</div>
						<div class="partner-img">
							<img src="website/assets/img/partner/partner2.svg" alt="img">
						</div>
						<div class="partner-img">
							<img src="website/assets/img/partner/partner3.svg" alt="img">
						</div>
						<div class="partner-img">
							<img src="website/assets/img/partner/partner4.svg" alt="img">
						</div>
						<div class="partner-img">
							<img src="website/assets/img/partner/partner5.svg" alt="img">
						</div>
						<div class="partner-img">
							<img src="website/assets/img/partner/partner6.svg" alt="img">
						</div>
					</div>
				</div>
			</div>
						...
						<div class="col-lg-6 col-12">
							<div class="col-md-12">
								<div class="heading aos" data-aos="fade-up">
									...
									<div class="scan-img">										
										<img src="website/assets/img/scan-img.png" class="img-fluid" alt="img">
									</div>
								</div>
							</div>
							<div class="downlaod-btn aos" data-aos="fade-up">
								<a href="#" target="_blank">
									<img src="website/assets/img/googleplay.svg" alt="img">
								</a>									
								<a href="#" target="_blank">
									<img src="website/assets/img/appstore.svg" alt="img">
								</a>
							</div>
						</div>
						<div class="col-lg-6 col-12">
							<div class="appimg-set aos" data-aos="fade-up">
								<img src="website/assets/img/app-img.png" class="img-fluid" alt="img">
							</div>
						</div>
					</div>
				</div>
  ...
  <!-- Footer -->
    @include('web.shared.components.footer')
  <!-- /Footer -->
