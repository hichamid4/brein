    ...
    <nav class="navbar navbar-expand-lg header-nav">
      <div class="navbar-header">
        ...
        <a href="index.html" class="navbar-brand logo">
          <img src="website/assets/img/logo.svg" class="img-fluid" alt="Logo">
        </a>
        <a href="index.html" class="navbar-brand logo-small">
          <img src="website/assets/img/logo-small.png" class="img-fluid" alt="Logo">
        </a>
      </div>
                  ...
                  <div class="row">
                    <div class="col-lg-2">
                      <div class="single-demo active">
                        <div class="demo-img">
                          <a href="index.html"><img src="website/assets/img/home-01.jpg" class="img-fluid" alt="img"></a>
                        </div>
                        <div class="demo-info">
                    ...
                    <div class="col-lg-2">
                      <div class="single-demo">
                        <div class="demo-img">
                          <a href="index-2.html"><img src="website/assets/img/home-02.jpg" class="img-fluid" alt="img"></a>
                        </div>
                        <div class="demo-info">
                    ...
                    <div class="col-lg-2">
                      <div class="single-demo">
                        <div class="demo-img">
                          <a href="index-3.html"><img src="website/assets/img/home-03.jpg" class="img-fluid" alt="img"></a>
                        </div>
                        <div class="demo-info">
                    ...
                    <div class="col-lg-2">
                      <div class="single-demo">
                        <div class="demo-img">
                          <a href="index-4.html"><img src="website/assets/img/home-04.jpg" class="img-fluid" alt="img"></a>
                        </div>
                        <div class="demo-info">
                    ...
                    <div class="col-lg-2">
                      <div class="single-demo">
                        <div class="demo-img">
                          <a href="index-5.html"><img src="website/assets/img/home-05.jpg" class="img-fluid" alt="img"></a>
                        </div>
                        <div class="demo-info">
                    ...
                    <div class="col-lg-2">
                      <div class="single-demo">
                        <div class="demo-img">
                          <a href="index-6.html"><img src="website/assets/img/home-06.jpg" class="img-fluid" alt="img"></a>
                        </div>
                        <div class="demo-info">
                    ...
                    <div class="col-lg-2">
                      <div class="single-demo">
                        <div class="demo-img">
                          <a href="index-7.html"><img src="website/assets/img/home-07.jpg" class="img-fluid" alt="img"></a>
                        </div>
                        <div class="demo-info">
                    ...
                    <div class="col-lg-2">
                      <div class="single-demo">
                        <div class="demo-img">
                          <a href="index-8.html"><img src="website/assets/img/home-08.jpg" class="img-fluid" alt="img"></a>
                        </div>
                        <div class="demo-info">
                    ...
                    <div class="col-lg-2">
                      <div class="single-demo">
                        <div class="demo-img">
                          <a href="index-9.html"><img src="website/assets/img/home-09.jpg" class="img-fluid" alt="img"></a>
                        </div>
                        <div class="demo-info">
      ...
      <ul class="nav header-navbar-rht">
        ...
        <li class="nav-item">
          <a class="nav-link header-login" href="login.html"><i class="fa-regular fa-circle-user me-2"></i>Login</a>
        </li>
      </ul>
    </nav>
  </div>
